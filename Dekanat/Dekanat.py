...
app.add_page(kinship.view_page, route=routes.KINSHIP_VIEW+"[id]", on_load=[kinship_states.ViewKinshipState.on_load, AuditHistoryState.load("kinship", Actions.KINSHIP_HISTORY_VIEW.value, Actions.KINSHIP_HISTORY_DETAIL.value)])
...
app.add_page(special_condition.view_page, route=routes.SPECIAL_CONDITION_VIEW+"[code]", on_load=[special_condition_states.ViewSpecialConditionState.on_load, AuditHistoryState.load("special_conditions", Actions.SPECIAL_CONDITION_HISTORY_VIEW.value, Actions.SPECIAL_CONDITION_HISTORY_DETAIL.value, "code")])
...
app.add_page(source_of_funding.view_page, route=routes.SOURCE_OF_FUNDING_VIEW+"[id]", on_load=[source_of_funding_states.ViewSourceOfFundingState.on_load, AuditHistoryState.load("source_of_funding", Actions.SOURCE_OF_FUNDING_HISTORY_VIEW.value, Actions.SOURCE_OF_FUNDING_HISTORY_DETAIL.value)])
...
app.add_page(department.view_page, route=routes.DEPARTMENT_VIEW+"[id]", on_load=[department_states.ViewDepartmentState.on_load, AuditHistoryState.load("departments", Actions.DEPARTMENT_HISTORY_VIEW.value, Actions.DEPARTMENT_HISTORY_DETAIL.value)])
...
app.add_page(speciality.view_page, route=routes.SPECIALITY_VIEW+"[spec_id]", on_load=[speciality_states.ViewSpecialityState.on_load, AuditHistoryState.load("specialties", Actions.SPECIALITY_HISTORY_VIEW.value, Actions.SPECIALITY_HISTORY_DETAIL.value, "spec_id")])
...
app.add_page(application_status.view_page, route=routes.APPLICATION_STATUS_VIEW+"[id]", on_load=[application_status_states.ViewApplicationStatusState.on_load, AuditHistoryState.load("application_statuses", Actions.APPLICATION_STATUS_HISTORY_VIEW.value, Actions.APPLICATION_STATUS_HISTORY_DETAIL.value)])
...
app.add_page(role.view_page, route=routes.ROLES_VIEW+"[id]", on_load=[role_states.ViewRoleState.on_load, AuditHistoryState.load("roles", Actions.ROLE_HISTORY_VIEW.value, Actions.ROLE_HISTORY_DETAIL.value)])
...
app.add_page(worker.view_page, route=routes.WORKERS_VIEW+"[id]", on_load=[worker_states.ViewWorkerState.on_load, AuditHistoryState.load("workers", Actions.WORKER_HISTORY_VIEW.value, Actions.WORKER_HISTORY_DETAIL.value)])
...
app.add_page(item_zno.view_page, route=routes.ITEM_ZNO_VIEW+"[id]", on_load=[item_zno_states.ViewItemZnoState.on_load, AuditHistoryState.load("item_zno", Actions.ITEM_ZNO_HISTORY_VIEW.value, Actions.ITEM_ZNO_HISTORY_DETAIL.value)])
...
app.add_page(entry_base.view_page, route=routes.ENTRY_BASE_VIEW+"[id]", on_load=[entry_base_states.ViewEntryBaseState.on_load, AuditHistoryState.load("entry_base", Actions.ENTRY_BASE_HISTORY_VIEW.value, Actions.ENTRY_BASE_HISTORY_DETAIL.value)])
...
app.add_page(form_of_study.view_page, route=routes.FORM_OF_STUDY_VIEW+"[id]", on_load=[form_of_study_states.ViewFormOfStudyState.on_load, AuditHistoryState.load("forms_of_study", Actions.FORM_OF_STUDY_HISTORY_VIEW.value, Actions.FORM_OF_STUDY_HISTORY_DETAIL.value)])
...
app.add_page(entrant_exam.view_page, route=routes.ENTRANT_EXAM_VIEW+"[id]", on_load=[entrant_exam_states.ViewEntrantExamState.on_load, AuditHistoryState.load("entrants_exams", Actions.ENTRANT_EXAM_HISTORY_VIEW.value, Actions.ENTRANT_EXAM_HISTORY_DETAIL.value)])
...
app.add_page(entrants_group.view_page, route=routes.ENTRANTS_GROUP_VIEW+"[id]", on_load=[entrants_group_states.ViewEntrantsGroupState.on_load, AuditHistoryState.load("entrants_groups", Actions.ENTRANTS_GROUP_HISTORY_VIEW.value, Actions.ENTRANTS_GROUP_HISTORY_DETAIL.value)])
...
app.add_page(entrant.view_page, route=routes.ENTRANT_VIEW+"[id]", on_load=[entrant_states.ViewEntrantState.on_load, AuditHistoryState.load("entrants", Actions.ENTRANT_HISTORY_VIEW.value, Actions.ENTRANT_HISTORY_DETAIL.value)])
...
app.add_page(app_setting.list_page, route=routes.SETTINGS, on_load=app_setting_states.ListAppSettingState.on_load)
...
app.add_page(admission_campaign.view_page, route=routes.ADMISSION_CAMPAIGN_VIEW+"[id]", on_load=[admission_campaign_states.ViewAdmissionCampaignState.on_load, AuditHistoryState.load("admission_campaigns", Actions.ADMISSION_CAMPAIGN_HISTORY_VIEW.value, Actions.ADMISSION_CAMPAIGN_HISTORY_DETAIL.value)])
