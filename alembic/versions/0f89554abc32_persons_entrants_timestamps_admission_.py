"""persons/entrants timestamps + admission_campaigns

Revision ID: 0f89554abc32
Revises: c7f62e0a6d51
Create Date: 2026-05-16 18:01:25.767351
...
revision: str = '0f89554abc32'
down_revision: Union[str, Sequence[str], None] = 'c7f62e0a6d51'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('entrants', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('application_status_changed_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('entrants', schema=None) as batch_op:
        batch_op.drop_column('application_status_changed_at')
        batch_op.drop_column('created_at')
